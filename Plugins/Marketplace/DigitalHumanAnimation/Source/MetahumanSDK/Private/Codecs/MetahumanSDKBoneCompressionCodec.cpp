...
FQuat UMetahumanSDKBoneCompressionCodec::GetTrackRotation(FAnimSequenceDecompressionContext& DecompContext, const int32 TrackIndex) const
{
	...
	double Alpha = TimeToIndex(SequenceLength, DecompContext.RelativePos, Tracks[TrackIndex].RotKeys.Num(), DecompContext.Interpolation, FrameA, FrameB);
...
FVector UMetahumanSDKBoneCompressionCodec::GetTrackLocation(FAnimSequenceDecompressionContext& DecompContext, const int32 TrackIndex) const
{
	...
	double Alpha = TimeToIndex(SequenceLength, DecompContext.RelativePos, Tracks[TrackIndex].PosKeys.Num(), DecompContext.Interpolation, FrameA, FrameB);
...
FVector UMetahumanSDKBoneCompressionCodec::GetTrackScale(FAnimSequenceDecompressionContext& DecompContext, const int32 TrackIndex) const
{
	...
	double Alpha = TimeToIndex(SequenceLength, DecompContext.RelativePos, Tracks[TrackIndex].ScaleKeys.Num(), DecompContext.Interpolation, FrameA, FrameB);
