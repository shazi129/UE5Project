...
void UUISelectableComponent::PostEditChangeProperty(FPropertyChangedEvent& PropertyChangedEvent)
{
	...
	if (PropertyChangedEvent.Property)
	{
		...
		{
			auto TargetUISpriteComp = Cast<UUISprite>(TransitionActor->GetUIRenderable());
			if (propertyName == TEXT("TransitionActor"))
			{
				if (TargetUISpriteComp) NormalUESprite = TargetUISpriteComp->GetUESprite();
			...
			else
			{
				...
				else if (Transition == UISelectableTransitionType::UESpriteSwap)
				{
					if (IsValid(TargetUISpriteComp) && IsValid(NormalUESprite))
					{
						TargetUISpriteComp->SetUESpriteData(isGroupAllowInteraction ? NormalUESpriteData : DisabledUESpriteData);
						TargetUISpriteComp->SetUESprite(isGroupAllowInteraction ? NormalUESprite : DisabledUESprite, false);
					}
					TransitionActor->GetUIRenderable()->EditorForceUpdate();
				}
...
void UUISelectableComponent::ApplySelectionState(bool immediateSet)
{
	...
	case EUISelectableSelectionState::Normal:
	{
		...
		break;
		case UISelectableTransitionType::UESpriteSwap:
		{
			auto TransitionTargetUIItemComp = TransitionActor->GetUIRenderable();
			if (auto TargetUISpriteComp = Cast<UUISprite>(TransitionTargetUIItemComp))
			{
				TargetUISpriteComp->SetUESprite(NormalUESprite, false);
				TargetUISpriteComp->SetUESpriteData(NormalUESpriteData);
			}
		}
		break;
	...
	case EUISelectableSelectionState::Highlighted:
	{
		...
		case UISelectableTransitionType::UESpriteSwap:
		{
			...
			if (auto TargetUISpriteComp = Cast<UUISprite>(TransitionTargetUIItemComp))
			{
				if (IsValid(HighlightedUESprite))
				{
					TargetUISpriteComp->SetUESprite(HighlightedUESprite, false);
					TargetUISpriteComp->SetUESpriteData(HighlightedUESpriteData);
				}
			}
		}
		break;
	...
	case EUISelectableSelectionState::Pressed:
	{
		...
		case UISelectableTransitionType::UESpriteSwap:
		{
			...
			if (auto TargetUISpriteComp = Cast<UUISprite>(TransitionTargetUIItemComp))
			{
				if (IsValid(PressedUESprite))
				{
					TargetUISpriteComp->SetUESprite(PressedUESprite, false);
					TargetUISpriteComp->SetUESpriteData(PressedUESpriteData);
				}
			}
		}
		break;
	...
	case EUISelectableSelectionState::Disabled:
	{
		...
		case UISelectableTransitionType::UESpriteSwap:
		{
			...
			if (auto TargetUISpriteComp = Cast<UUISprite>(TransitionTargetUIItemComp))
			{
				if (IsValid(DisabledUESprite))
				{
					TargetUISpriteComp->SetUESprite(DisabledUESprite, false);
					TargetUISpriteComp->SetUESpriteData(DisabledUESpriteData);
				}
			}
		}
		break;
...
void UUISelectableComponent::SetNormalUESprite(UPaperSprite* NewSprite)
{
	if (NormalUESprite != NewSprite)
	{
		NormalUESprite = NewSprite;
		if (CurrentSelectionState == EUISelectableSelectionState::Normal)
		{
			ApplySelectionState(false);
		}
...
void UUISelectableComponent::SetHighlightedUESprite(UPaperSprite* NewSprite)
{
	if (HighlightedUESprite != NewSprite)
	{
		HighlightedUESprite = NewSprite;
		if (CurrentSelectionState == EUISelectableSelectionState::Highlighted)
		{
			ApplySelectionState(false);
		}
...
void UUISelectableComponent::SetPressedUESprite(UPaperSprite* NewSprite)
{
	if (PressedUESprite != NewSprite)
	{
		PressedUESprite = NewSprite;
		if (CurrentSelectionState == EUISelectableSelectionState::Pressed)
		{
			ApplySelectionState(false);
		}
