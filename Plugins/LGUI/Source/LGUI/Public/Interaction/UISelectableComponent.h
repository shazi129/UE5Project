...
enum class UISelectableTransitionType:uint8
{
	...
	UESpriteSwap		UMETA(DisplayName = "UESpriteSwap"),
};
UENUM(BlueprintType, Category = LGUI)
...
#pragma region Transition
	...
	UPROPERTY(EditAnywhere, Category = "LGUI-Selectable")
		UPaperSprite* NormalUESprite;
	UPROPERTY(EditAnywhere, Category = "LGUI-Selectable")
		UPaperSprite* HighlightedUESprite;
	UPROPERTY(EditAnywhere, Category = "LGUI-Selectable")
		UPaperSprite* PressedUESprite;
	UPROPERTY(EditAnywhere, Category = "LGUI-Selectable")
		UPaperSprite* DisabledUESprite;

	UPROPERTY(EditAnywhere, Category = "LGUI-Selectable")
		FUESpriteData NormalUESpriteData;
	UPROPERTY(EditAnywhere, Category = "LGUI-Selectable")
		FUESpriteData HighlightedUESpriteData;
	UPROPERTY(EditAnywhere, Category = "LGUI-Selectable")
		FUESpriteData PressedUESpriteData;
	UPROPERTY(EditAnywhere, Category = "LGUI-Selectable")
		FUESpriteData DisabledUESpriteData;
...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "LGUI-Selectable")
		UPaperSprite* GetNormalUESprite()const { return NormalUESprite; }
	UFUNCTION(BlueprintCallable, Category = "LGUI-Selectable")
		void SetNormalUESprite(UPaperSprite* NewSprite);
	UFUNCTION(BlueprintCallable, Category = "LGUI-Selectable")
		UPaperSprite* GetHighlightedUESprite()const { return HighlightedUESprite; }
	UFUNCTION(BlueprintCallable, Category = "LGUI-Selectable")
		void SetHighlightedUESprite(UPaperSprite* NewSprite);
	UFUNCTION(BlueprintCallable, Category = "LGUI-Selectable")
		UPaperSprite* GetPressedUESprite()const { return PressedUESprite; }
	UFUNCTION(BlueprintCallable, Category = "LGUI-Selectable")
		void SetPressedUESprite(UPaperSprite* NewSprite);
