...
struct FUESpriteData
{
	GENERATED_BODY()

	UPROPERTY(EditAnywhere, Category = "LGUI")
		float ueSpriteBorderLeft = 0;
	UPROPERTY(EditAnywhere, Category = "LGUI")
		float ueSpriteBorderRight = 0;
	UPROPERTY(EditAnywhere, Category = "LGUI")
		float ueSpriteBorderTop = 0;
	UPROPERTY(EditAnywhere, Category = "LGUI")
		float ueSpriteBorderBottom = 0;
	UPROPERTY(EditAnywhere, Category = "LGUI")
		float ueSpritePaddingLeft = 0;
	UPROPERTY(EditAnywhere, Category = "LGUI")
		float ueSpritePaddingRight = 0;
	UPROPERTY(EditAnywhere, Category = "LGUI")
		float ueSpritePaddingTop = 0;
	UPROPERTY(EditAnywhere, Category = "LGUI")
		float ueSpritePaddingBottom = 0;
};
...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "LGUI") const FUESpriteData& GetUESpriteData();
	UFUNCTION(BlueprintCallable, Category = "LGUI") void SetUESpriteData(const FUESpriteData& data);
};
