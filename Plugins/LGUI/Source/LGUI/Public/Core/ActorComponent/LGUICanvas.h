...
UENUM(BlueprintType, Category = LGUI)
enum class ELGUIMaskType : uint8
{
	BlackWhite = 0,
	Alpha = 1,
	InvBlackWhite = 2,
...
protected:
	...
	UPROPERTY(EditAnywhere, Category = LGUI)
		FVector2D maskPivot = FVector2D(0.5, 0.5);
	UPROPERTY(EditAnywhere, Category = LGUI)
		FVector2D maskScale = FVector2D(1.0, 1.0);
	UPROPERTY(EditAnywhere, Category = LGUI, meta=(UIMin="0", UIMax="360"))
		float maskRotation = 0.0f;
	UPROPERTY(EditAnywhere, Category = LGUI)
		ELGUIMaskType maskType = ELGUIMaskType::BlackWhite;
	...
	FORCEINLINE float GetTextureClipRotationAngle() { return maskRotation; }
	FORCEINLINE ELGUIMaskType GetTextureClipType() { return maskType; }
...
public:
	...
	UFUNCTION(BlueprintCallable, Category = LGUI)
		void SetMaskPivot(FVector2D& vec);
	UFUNCTION(BlueprintCallable, Category = LGUI)
		void SetMaskScale(FVector2D& vec);
	UFUNCTION(BlueprintCallable, Category = LGUI)
		void SetMaskRotation(float rotation);
	UFUNCTION(BlueprintCallable, Category = LGUI)
		void SetMaskType(ELGUIMaskType type);
	...
	UFUNCTION(BlueprintCallable, Category = LGUI)
		FVector2D GetMaskPivot() const { return maskPivot; }
	UFUNCTION(BlueprintCallable, Category = LGUI)
		FVector2D GetMaskScale() const { return maskScale; }
	UFUNCTION(BlueprintCallable, Category = LGUI)
		float GetMaskRotation() const { return maskRotation; }
	UFUNCTION(BlueprintCallable, Category = LGUI)
		ELGUIMaskType GetMaskType() const { return maskType; }
...
public:
	...
	static FName LGUI_TextureClipRotationAngle_MaterialParameterName;
	static FName LGUI_TextureClipType_MaterialParameterName;
