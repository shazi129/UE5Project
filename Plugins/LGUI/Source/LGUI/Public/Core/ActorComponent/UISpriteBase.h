...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "LGUI") UPaperSprite* GetUESprite()const { return ueSprite; }
	UFUNCTION(BlueprintCallable, Category = "LGUI")
		void SetUESprite(UPaperSprite* newSprite, bool setSize = true);
};
