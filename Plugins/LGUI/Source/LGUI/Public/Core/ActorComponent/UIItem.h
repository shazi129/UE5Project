...
protected:
	...
	UPROPERTY(EditAnywhere, Category = LGUI, meta = (DisplayName = "Is UI Hidden"))
...
public:
	...
	UFUNCTION(BlueprintCallable, Category = LGUI)
		void SetIsUIHidden(bool hidden) { bIsUIHidden = hidden; }
	UFUNCTION(BlueprintCallable, Category = LGUI)
		FORCEINLINE bool GetIsUIHidden()const { return bIsUIHidden; }
...
protected:
	bool bAllUpParentBeRaycastTarget = true;
	UPROPERTY(EditAnywhere, Category = "LGUI-Raycast")
		bool bNotHitChildren = false;
	/**
	...
	void CheckChildrenRaycastRecursive(bool inUpParentBeRaycastTarget);
public:
	UFUNCTION(BlueprintCallable, Category = LGUI)
		bool IsNotHitChildren() const { return bNotHitChildren; }
	UFUNCTION(BlueprintCallable, Category = LGUI)
		void SetIsNotHitChildren(bool notHitChildren);
	UFUNCTION(BlueprintCallable, Category = LGUI)
		bool IsRaycastTarget() const { return bRaycastTarget && bAllUpParentBeRaycastTarget; }
	UFUNCTION(BlueprintCallable, Category = LGUI)
