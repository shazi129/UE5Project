...
namespace Inworld
{
	...
	public:
		...
		virtual void StartClient(const ClientOptions& Options, std::function<void(const std::vector<AgentInfo>&)> LoadSceneCallback);
		virtual void StartClient(const std::string& Token, const std::string& SessionId, const ClientOptions& Options, std::function<void(const std::vector<AgentInfo>&)> LoadSceneCallback);
	...
	private:
		void LoadScene(const std::string& Token, const std::string& SessionId, const ClientOptions& Options);
