	...
	: Super(ObjectInitializer)
{
	...
	PlayerAudioCaptureComponent = UAudioCaptureComponent::StaticClass();

	static ConstructorHelpers::FObjectFinder<USoundSubmixBase> DefaultMuteSubmixObject(TEXT("SoundSubmix'/InworldAI/DefaultMuteMicSubmix.DefaultMuteMicSubmix'"));
	if (DefaultMuteSubmixObject.Succeeded())
	{
		PlayerMuteSoundSubmix = DefaultMuteSubmixObject.Object;
	}
