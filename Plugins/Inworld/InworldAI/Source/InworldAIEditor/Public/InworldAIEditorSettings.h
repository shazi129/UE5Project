...
public:
	...
	UPROPERTY(config, EditAnywhere, Category = "Player")
	TSubclassOf<UAudioCaptureComponent> PlayerAudioCaptureComponent;

	UPROPERTY(EditAnywhere, Category = "Player", meta = (EditCondition = false))
	class USoundSubmixBase* PlayerMuteSoundSubmix;
